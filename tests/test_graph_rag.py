...
class TestRouter:
    ...
    def test_route_local_entity_query(self):
        ...
        assert decision.strategy in (
            SearchStrategy.LOCAL_GRAPH,
            SearchStrategy.HYBRID_GRAPH,
        )
    ...
    def entities_and_rels(self):
        ...
        relationships = [
            ...
            Relationship(
                ...
                relationship_type="RELATED_TO",
                description="",
                source_entity_id=ids[3],
                target_entity_id=ids[4],
            ),
        ]
